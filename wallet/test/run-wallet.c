...
u8 *towire_channeld_send_shutdown(const tal_t *ctx UNNEEDED, u32 final_index UNNEEDED, const struct ext_key *final_ext_key UNNEEDED, const u8 *shutdown_scriptpubkey UNNEEDED, const struct bitcoin_outpoint *wrong_funding UNNEEDED)

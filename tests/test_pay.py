...
@unittest.skipIf(os.getenv('SUBDAEMON').startswith('hsmd:remote_hsmd'), "bolt12: InvalidSemantics(UnsupportedCurrency)")
...
@unittest.skipIf(os.getenv('SUBDAEMON').startswith('hsmd:remote_hsmd'), "bolt12 invoice recurrence unsupported")
